...
<div class="details">
    <div class="details_operation clearfix">
        ...
        <form action="ClassServlet?act=addresult" method="post">
            <table width="35%" border="1" cellpadding="5" cellspacing="0" bgcolor="#ccc" >
                <tr>
                    <td align="center" width="20%">班级编号</td>
                    <td><input type="text" name="classid" placeholder="     请输入班级编号"></td>
                </tr>
                <tr>
                    <td align="center">班级名称</td>
                    <td><input type="text" name="classname" placeholder="     请输入班级名称"></td>
                </tr>
            </table>
            <br />
